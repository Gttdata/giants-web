...
import { LadyDetailAndDocumentModel } from 'src/app/Models/LadyMemberAward';
import { ApiService } from 'src/app/Service/api.service';

@Component({
  selector: 'app-doc-and-details-drawe',
  templateUrl: './doc-and-details-drawe.component.html',
  styleUrls: ['./doc-and-details-drawe.component.css']
})
export class DocAndDetailsDraweComponent implements OnInit {

  @Input() drawerClose!: Function;
  @Input() drawerVisible: boolean = false;
  @Input() data: LadyDetailAndDocumentModel = new LadyDetailAndDocumentModel();
  ...
  @Input() LadyDocAndDetDrawerClose:Function;
