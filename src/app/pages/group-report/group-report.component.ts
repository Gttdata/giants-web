...
export class GroupReportComponent implements OnInit {
  columns: string[][] = [
    ["NAME", "Federation Name"], ["UNIT_NAME", "Name Of Unit "],
    ["GROUP_NAME", "Name of Group "], ["MEMBER_COUNT", "No. Of Member"], ["MEETING_COUNT", "No.Of Meeting"],
    ["POST_COUNT", "No. Of Post"], ["EVENT_COUNT", "No. Of Event"], ["PUBLISHED_CIRCULAR", "No. Of Circular"], ["PROJECTS_COUNT", "No. Of Project"]];
  Operators: string[][] = [["Between", "Between"], ["=", "="], [">", ">"], ["<", "<"], [">=", ">="], ["<=", "<="], ["<>", "!="]];
  multipleValue = [];
  Operators_name: string[][] = [["Start With", "Start With"], ["End With", "End With"], ["=", "="], ["<>", "!="], ['Content', 'Content']];
  formTitle = "Group Level Report";
  a = new Date();
  ...
  SelectYear(YEARs: any) {
    ...
    this.api.getGroupReport(this.pageIndex, this.pageSize, this.sortKey, this.sortValue, "", this.SelectedYear, filters, this.federationId, this.UnitId, this.GroupId).subscribe(data => {
      if ((data['code'] == 200)) {
  ...
  search(reset: boolean = false, exportToExcel: boolean = false, exportToPDF: boolean = false) {
    ...
    if (exportToExcel) {
      ...
      this.api.getGroupReport(0, 0, this.sortKey, this.sortValue, "", this.SelectedYear, filters, this.federationId, this.UnitId, this.GroupId).subscribe(data => {
        if (data['code'] == 200) {
      ...
      this.api.getGroupReport(this.pageIndex, this.pageSize, this.sortKey, this.sortValue, "", this.SelectedYear, filters, this.federationId, this.UnitId, this.GroupId).subscribe(data => {
        if (data['code'] == 200) {
          ...
          this.federations = data['data'];
          this.totalRecords = data['count'];
          console.log("LOADING RECORD", this.loadingRecords);
        }
  ...
  convertInExcel() {
    ...
    for (var i = 0; i < this.dataListForExport.length; i++) {
      ...
      if (this.Col2 == true) {
        obj1['Total Unit'] = this.dataListForExport[i]['UNIT_NAME'];
      }
      if (this.Col3 == true) {
        obj1['Total Group'] = this.dataListForExport[i]['GROUP_NAME'];
      }
      if (this.Col4 == true) {
        obj1['Total Member'] = this.dataListForExport[i]['MEMBER_COUNT'];
      }
      if (this.Col5 == true) {
        obj1['Total Meeting '] = this.dataListForExport[i]['MEETING_COUNT'];
      }
      if (this.Col6 == true) {
      ...
      if (this.Col12 == true) {
        obj1['Total Post'] = this.dataListForExport[i]['POST_COUNT'];
      }
      if (this.Col13 == true) {
      ...
      if (this.Col19 == true) {
        obj1['Total Event'] = this.dataListForExport[i]['EVENT_COUNT'];
      }
      if (this.Col20 == true) {
      ...
      // if (this.Col22 == true) {
      //   obj1['Total Beneficiaries'] = this.dataListForExport[i]['EVENT_TOTAL_BENEFICIARIES'];
      // }
      if (this.Col24 == true) {
        obj1['Total Circular'] = this.dataListForExport[i]['CIRCULAR_COUNT'];
      }
      if (this.Col25 == true) {
        obj1['Total Circular Created'] = this.dataListForExport[i]['CIRCULAR_COUNT'];
      }
      if (this.Col26 == true) {
      ...
      if (this.Col29 == true) {
        obj1['Total Project'] = this.dataListForExport[i]['PROJECTS_COUNT'];
      }
      if (this.Col30 == true) {
      ...
      // if (this.Col35 == true) {
      //   obj1['Project Total Beneficiaries'] = this.dataListForExport[i]['PROJECT_TOTAL_BENEFICIARIES'];
      // }
      arry1.push(Object.assign({}, obj1));
      if (i == this.dataListForExport.length - 1) {
        this._exportService.exportExcel(arry1, 'Group Wise Count ' + this.datePipe.transform(new Date(), 'dd-MMM-yy, hh mm ss a'));
      }
    }
  }
  ...
  getFederation() {
    ...
    this.api.getGroupReport(this.pageIndex, this.pageSize, this.sortKey, this.sortValue, "", this.SelectedYear, "", this.federationId, this.UnitId, this.GroupId).subscribe(data => {
      if ((data['code'] == 200)) {
        this.federations = data['data'];
        this.totalRecords = data['count'];
        this.loadingRecords = false;
  ...
  getGroupReport() {
    ...
    //   filters = ''
    // }
    this.api.getGroupReport(this.pageIndex, this.pageSize, "GROUP_NAME", "asc", "", this.SelectedYear, this.all_filter, this.federationId, this.UnitId, this.GroupId).subscribe(data => {
      if ((data['code'] == 200)) {
        this.federations = data['data'];
        this.totalRecords = data['count'];
        this.loadingRecords = false;
  ...
  CloseGroupMeetCount1(i: any, j: any) {
  ...
  ApplyFilterMeetCount() {
    if (this.mainFilterArrayMeet.length != 0) {
      ...
      if (isok == true) {
        console.log(this.filterMeetingCount);
  ...
  ApplyFilterPostCount() {
    if (this.mainFilterArrayPost.length != 0) {
      ...
      if (isok == true) {
        console.log(this.ApplyfilterPost);
  ...
  ApplyFilterEventCount() {
    if (this.mainFilterArrayEvent.length != 0) {
      ...
      if (isok == true) {
        console.log(this.ApplyfilterEvent);
  ...
  ApplyFilterAvgAttend() {
    if (this.mainFilterArrayAvgAttend.length != 0) {
      ...
      if (isok == true) {
        console.log(this.filterAvgAttendence);
  ...
  ApplyFilterAvgMeetPerDay() {
    if (this.mainFilterArrayAvgMeetPerDay.length != 0) {
      ...
      if (isok == true) {
        console.log(this.filterMeetPerDay);
  ...
  ApplyFilterAvgMeetPerGroup() {
    if (this.mainFilterArrayAvgMeetPerGroup.length != 0) {
      ...
      if (isok == true) {
        console.log(this.filterMeetpergrp);
  ...
  ApplyFilterTotalPostLikes() {
    if (this.mainFilterArrayTotalPostLikes.length != 0) {
      ...
      if (isok == true) {
        console.log(this.filterPostLike);
  ...
  ApplyFilterTotalPostComment() {
    if (this.mainFilterArrayTotalPostComment.length != 0) {
      ...
      if (isok == true) {
        console.log(this.filterPostComm);
  ...
  ApplyFilterAvgPostPerMember() {
    if (this.mainFilterArrayAvgPostPerMember.length != 0) {
      ...
      if (isok == true) {
        console.log(this.filterPostPerMem);
  ...
  showModalEventTotalBeneficiaries() {
    ...
    this.model = "EVENT_TOTAL_BENEFICIARIES";
  }
  ...
  showModalUnitcount() {
    ...
    this.ModelName = "Name Of Unit Filter";
  ...
  closeFedSheduleDrawer(): void {
    this.drawerVisible = false;
  }

  get closeCallbackFedShedule() {
    return this.closeFedSheduleDrawer.bind(this);
  }
  ScheduleTitle = '';
  ...
  goToSchedule(reset: boolean = false, loadMore: boolean = false): void {
    this.ScheduleTitle = "Group Report";
